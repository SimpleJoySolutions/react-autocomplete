...
var Autocomplete = function (_React$Component) {
  ...
  function Autocomplete(props) {
    ...
    _this.handleKeyboardSelection = _this.handleKeyboardSelection.bind(_this);
    ...
    value: function handleKeyboardSelection(event) {
      ...
      if (!this.isOpen()) {
        ...
        this.setState({
          ...
          _this3.props.onSelect(value, item, key);
        });
      }
    }
  }, {
...
Autocomplete.propTypes = {
  ...
  /**
   * Determines whether or not tab key should select the current item
   */
